			...
			<div class="col-md-2"></div>
				<div class="col-md-8 p-4 border mb-4">
					...
					<div class="row mb-4" style="justify-content: center">
						<form class="row" action="<%= request.getContextPath() %>/ModifierVente" method="post" enctype="multipart/form-data" >
							...
							<div class="col-md-7 p-1 mb-1">
								<div class="input-group mb-3">
									...
									name="sarticle" value="${empty sarticle? articleVendu.nom_article:sarticle}">
								</div>
							</div>
							...
							<div class="col-md-7 p-1 mb-1">
								<div class="input-group mb-3">
									...
									name="sdecscription">${empty sdecscription? articleVendu.description:sdecscription}</textarea>
								</div>
							</div>
							...
							<div class="col-md-7 p-1 mb-1">
								<div class="input-group mb-3">
									...
									name="sprix" value="${empty sprix? articleVendu.prix_initial:sprix}">
								</div>
							</div>
							...
							<div class="col-md-7 p-1 mb-1">
								<div class="input-group mb-3">
									...
									name="sdate_debut" value="${empty sdate_debut? articleVendu:sdate_debut}">
									...
									<div class="col-md-7 p-1 mb-1">
										<div class="input-group mb-3">
											<c:if test="${empty scode_postal}">
												...
												name="scode_postal" value="${retrait.code_postale}">
											</c:if>
											<c:if test="${!empty scode_postal}">
												<input type="number" class="form-control" id="idcodepostal"
									...
									<div class="col-md-7 p-1 mb-1">
										<div class="input-group mb-3">
											<c:if test="${empty sville}">
												...
												name="sville" value="${retrait.ville}">
											</c:if>
											<c:if test="${!empty sville}">
												<input type="text" class="form-control" id="idville"
							...
							<div class="col-md-12 p-4 mb-2">
								<div class="row text-center">	
									<input class="btn btn-success me-2" type="submit" value="Modifer">
								</div>
							</div>
							<div class="col-md-12 p-4 mb-2">
								<div class="row text-center">	
